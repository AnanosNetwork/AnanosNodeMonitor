...
// project URL
define('PROJECT_URL', 'https://github.com/AnanosNetwork/AnanosNodeMonitor');

// URL to get version of latest release from github
define('GITHUB_LATEST_API_URL', 'https://api.github.com/repos/AnanosNetwork/AnanosNodeMonitor/releases/latest');
...
// ananos rep account for Nano Node Monitor 
define ('NODEMON_ANA_REP_ACCOUNT', 'ana_1qtj3urhp6q8inbm6zzt96gerg7d4umdxq3rx8be7rh8ycjzi1e3q9oym9iu');
