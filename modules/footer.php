<footer id="footer">
  ...
  <small>
    ...
    <?php
      // switch Nano / Banano / Ananos rep accounts & explorer
      ...
      if ($currency == "banano")
      {
        ...
        $repExplorer = 'banano';
      } elseif ($currency == "ananos")
      {
        $repAccount = NODEMON_ANA_REP_ACCOUNT;
        $donAccount = NODEMON_ANA_REP_ACCOUNT;
        $repExplorer = 'ananos';
      }
    ?>
    ...
    <ul>
      ...
      <li>Powered by <a href="<?php echo PROJECT_URL ?>" target="_blank" rel="noopener">Ananos Node Monitor</a></li>
